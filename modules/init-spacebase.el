  ...
  (spacebase/with-project-directory
   (let ((kill-buffer-query-functions nil)
         ...
         (commands '(("Spacebase runserver" "*Spacebase: runserver*" "python manage.py runserver")
                     ("Spacebase celery" "*Spacebase: celery_worker_0*" "python manage.py celery_worker -n 0")
                     ("Spacebase celery" "*Spacebase: celery_worker_1*" "python manage.py celery_worker -n 1")
